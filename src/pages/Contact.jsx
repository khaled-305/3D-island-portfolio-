  ...
  return (
    <section className='relative flex lg:flex-row flex-col max-container'>
      ...
      <div className='flex-1 min-w-[50%] flex flex-col'>
        ...
        <span className="flex flex-row flex-wrap my-5">
          <LinkedInIcon className="text-blue-500 mr-2" />
          <p className="pr-3 font-bold">Linkedin: </p>
        ...
        <span className="flex flex-row my-5">
          <EmailIcon className="text-red-300 mr-2"/>
          <p className="pr-3 font-bold">Email: </p>
        ...
        <span className="flex flex-row my-5">
          ...
          <p className="pr-3 font-bold">GitHub: </p>
        ...
        <span className="flex flex-row my-5">
          <LocalPhoneIcon className="text-blue-500 mr-2" />
          <p className="pr-3 font-bold">Phone: </p>
          <a href="#" className="text-blue-500 hover:text-blue-700">
            +2348164993630
          </a>
        </span>
